...
public class DisplayExpenseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        expensesListView.setOnItemLongClickListener((parent, view1, position, id) -> {
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton("Update", (dialog, which) -> updateTransaction(selectedTransaction))
                    .setNegativeButton("Delete", (dialog, which) -> deleteTransaction(selectedTransaction))
    ...
    private void loadExpenses() {
        ...
        adapter = new ArrayAdapter<>(Objects.requireNonNull(Objects.requireNonNull(Objects.requireNonNull(Objects.requireNonNull(getContext())))), android.R.layout.simple_list_item_1, expenseDescriptions);
...
//        builder.setTitle("Update Transaction");
    ...
    private void filterTransactions(String startDate, String endDate, String category) {
        ...
        transactionList = dbHelper.getFilteredTransactions(startDate, endDate, category);
