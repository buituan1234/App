...
public class ManageCategoryFragment extends Fragment {
    ...
    private void loadCategories() {
        ArrayList<Category> categoryList = (ArrayList<Category>) dbHelper.getAllCategoryByEmail(DataStatic.email);
        ...
        ArrayAdapter<String> categoryAdapter = new ArrayAdapter<>(requireContext(), android.R.layout.simple_list_item_1, categoryNames);
